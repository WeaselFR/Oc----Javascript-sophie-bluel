...
const getWorks = (id) => {
  // Effectue une requête GET à l'API pour obtenir les données des œuvres.
...
if (dataStorage) {
  ...
  // Décale la galerie de 90px vers le bas pour éviter la superposition avec le titre "projets".
...
function showModalTwo() {
  ...
  // Définit le contenu HTML de la deuxième modal
  const divModal2 = `
    <div class="divModal2">
